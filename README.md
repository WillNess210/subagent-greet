...
- **Without it** — main agent: *"review my changes"* → the subagent has no idea what changed or why, reviews the entire `git diff`, can't separate intentional changes from bugs → main agent gets noise.
